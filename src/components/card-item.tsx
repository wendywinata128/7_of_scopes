  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute h-full w-full bg-white rounded text-black p-1 px-2 text-sm flex flex-col justify-between transition shrink-0 overflow-hidden hover:bg-gray-300  ${
        ...
        >
          ...
          <div
            className={`flex flex-col items-center w-fit rotate-180 ml-auto ${
              (type === "diamond" || type === "heart") && "text-red-700"
            }`}
          >
            <p>{character}</p>
